...
/* harmony import */ var _modules_page_header_menu__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./modules/page-header-menu */ "./js/modules/page-header-menu.js");
/* harmony import */ var _modules_portfolios__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./modules/portfolios */ "./js/modules/portfolios.js");
...
window.addEventListener('DOMContentLoaded', function () {
  ...
  var scrollSmooth = function scrollSmooth() {
    return scroll;
  };
  scrollSmooth();
  ...
  window.addEventListener('load', function () {
    ...
    Object(_modules_page_header_menu__WEBPACK_IMPORTED_MODULE_2__["switchMenu"])();
    Object(_modules_portfolios__WEBPACK_IMPORTED_MODULE_3__["manageVisibility"])();
  });
});
...
/***/ "./js/modules/page-header-menu.js":
/*!****************************************!*\
  !*** ./js/modules/page-header-menu.js ***!
  \****************************************/
/*! exports provided: switchMenu */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
var wrapperBackgroun = document.querySelector('.background-wrapper');
var listMenu = document.querySelector('.page-header__list');
var links = document.querySelectorAll('.page-header__link');
var items = document.querySelectorAll('.page-header__item');
var wrapper = document.querySelector('.wrapper');
var wrapperMenu = document.querySelector('.page-header__wrapper');
var wrapperOverlay = document.querySelector('.wrapper__overlay');
var clickOutside = function clickOutside(e) {
  var headerOpen = document.querySelector('.page-header--open');
...
/***/ "./js/modules/portfolios.js":
/*!**********************************!*\
  !*** ./js/modules/portfolios.js ***!
  \**********************************/
/*! exports provided: manageVisibility */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "manageVisibility", function() { return manageVisibility; });
var portfolios = document.querySelectorAll('.portfolios__item');
var hideElements = function hideElements() {
  var windowInnerWidth = window.innerWidth;
  if (windowInnerWidth >= 678) {
    var portfoliosDesktop = document.querySelectorAll('.portfolios__item--hidden-desktop');
    portfolios.forEach(function (element) {
      element.classList.remove('hidden');
    });
    portfoliosDesktop.forEach(function (element) {
      element.classList.add('hidden');
    });
  } else {
    var portfoliosMobile = document.querySelectorAll('.portfolios__item--hidden-mobile');
    portfolios.forEach(function (element) {
      element.classList.remove('hidden');
    });
    portfoliosMobile.forEach(function (element) {
      element.classList.add('hidden');
    });
  }
};
...
var manageVisibility = function manageVisibility() {
  var button = document.querySelector('.portfolios__button');
  hideElements();
  button.addEventListener('click', function () {
    var buttonTextClose = document.querySelector('.portfolios__button-text--close');
    var buttonTextOpen = document.querySelector('.portfolios__button-text--open');
